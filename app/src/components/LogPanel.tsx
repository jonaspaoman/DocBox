  ...
  return (
    <div className="flex flex-col h-full bg-white">
      <div className="px-3 py-2.5 border-y border-border/30 flex items-center justify-between shrink-0">
        ...
        <span className="text-[10px] font-mono text-gray-400 tabular-nums bg-gray-100 px-1.5 py-0.5 rounded">
          {entries.length}
        </span>
      </div>
      <div ref={scrollRef} className="flex-1 overflow-y-auto min-h-0">
        {entries.length === 0 ? (
          <p className="text-gray-300 text-[11px] font-mono py-8 text-center">
            Waiting for events...
          </p>
        ) : (
          <div className="py-1">
              ...
              >
                ...
                <div className="min-w-0 flex-1">
                  <div className="flex items-baseline gap-1.5">
                    <span className="text-[11px] font-mono text-gray-700 truncate max-w-[100px]">
                      {entry.patientName}
                    </span>
                  ...
                  <div className="flex items-center gap-1.5 text-[9px] font-mono text-gray-300">
