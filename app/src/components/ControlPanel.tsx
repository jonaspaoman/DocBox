...
export function ControlPanel({
  ...
  return (
    <div className="border-t border-gray-200 bg-white px-6 py-2.5 flex items-center gap-6 flex-wrap">
      {/* Start / Pause / Resume / Reset / Add Patient */}
      <div className="flex gap-1.5">
        {simState.is_running ? (
          <Button variant="outline" size="sm" className="font-mono text-xs h-7 border-yellow-500/50 text-yellow-600 hover:bg-yellow-500/10 gap-1.5" onClick={onStop}>
